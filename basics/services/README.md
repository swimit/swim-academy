...
Execute the command `gradle runClient` from a shell pointed to the application's home directory. This will start the client.
   ...
   ```
## Run the UI
Go to the [ui](https://github.com/swimit/swim-academy/tree/master/basics/ui) directory. Run a `web server` of your choice in this directory. This is needed to load the Swim UI components. Please refer to the [README in the ui directory](https://github.com/swimit/swim-academy/tree/master/basics/ui/README.md) for details on these components. 
